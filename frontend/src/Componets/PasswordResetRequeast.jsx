...
function PasswordResetRequeast() {
    ...
    return (
      <div className={'background'}>
         {Showmessage? <Mymessage text={' if your email is exists you will have get a message your on your email with an instruction'}/>:null}
              <form onSubmit={handleSubmit(submission)}>
              
           <Box className={'whitbox'}>
                  <Box className="items">
                    <Box className="title"> Password Resat Request page</Box>
                  </Box>
                  <Box className="items">
                      <Myemail 
                          label='Email'
